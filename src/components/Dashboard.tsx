      ...
      <header className="relative z-10 border-b border-white/[0.06]">
        <div className="container max-w-6xl mx-auto px-4 py-10 sm:py-14">
            ...
            <div>
              ...
              {curriculum && (
                <p className="text-sm text-muted-foreground mt-1">
                  ...
                  {curriculum.academic_session && ` · ${curriculum.academic_session}`}
                  {curriculum.is_demo && (
                    <span className="ml-2 text-[10px] font-bold uppercase tracking-widest text-amber-400/70">[Demo]</span>
                  )}
                </p>
              )}
            </div>
          ...
          <p className="text-muted-foreground text-base sm:text-lg max-w-2xl leading-relaxed">
            Track your graduation progress, estimate your CGPA, and manage your course history — all securely stored on your device.
          </p>
        </div>
      </header>
